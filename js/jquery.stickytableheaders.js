        ...
        function Plugin(el, options) {
            ...
            base.init = function () {
                base.$el.each(function () {
                    ...
                    $this.css('padding', 0);
                    // select for original head of table
                    base.$originalHeader = $('thead:first', this);
                    // clone the header
                    base.$clonedHeader = base.$originalHeader.clone();
                    // trigger cloned header, pass in clonedHeader to whoever is listening
                    $this.trigger('clonedHeader.' + name, [base.$clonedHeader]);
                    // add tableFloatingHeader to cloned header
                ...
                base.updateWidth(); // set max-width to cloned header's width (should be same width still)
                base.toggleHeaders();
                base.bind();
            };
...
//                console.log('update width triggered');
                // if not sticky don't do anything
                if (!base.isSticky) {
                    return;
                }
...
//                console.log('reset width triggered');
                $clonedHeaders.each(function (index) {
                    var $this = $(this);
                    $origHeaders.eq(index).css({
